class Level2 extends Phaser.Scene {
  ...
  preload() {
    this.load.image('tile1', './assets/scene2/场景2第一幕/A4.png');
    this.load.image('tile2', './assets/scene2/场景2第一幕/Inside_C.png');
    this.load.image('tile3', './assets/scene2/场景2第一幕/A5.png');
    this.load.image('tile4', './assets/scene2/场景2第一幕/Inside_D.png');
    this.load.image('tile5', './assets/scene2/场景2第一幕/Inside_E.png');
    ...
    this.load.tilemapTiledJSON('gamemap_2', './assets/scene2/场景2第一幕/changjing2.tmj');  
    // this.load.tilemapTiledJSON('gamemap_2', './assets/scene2/场景2终点幕/zhongdian2.tmj');  
  ...
  create() {
    const map = this.add.tilemap('gamemap_2');
  ...
  update() {
    ...
    for (let i = 0; i < this.gn; i++) {
      ...
      if (this.johnny_wife.x >= 1408) {
        ...
        this.add.text(this.johnny_wife.x - 155, this.johnny_wife.y - 70, 'N: next'); 
        this.add.text(this.johnny_wife.x - 155, this.johnny_wife.y - 40, 'E: menu'); 
      }
      ...
      if (key_n.isDown && this.winner == 'johnny wifi') {
        ...
        this.v_ = 1.5
        this.bgm.stop();
        this.scene.start('level2_1Scene');
      }
    }
